...
def convert_namespace_to_omegaconf(args: Namespace) -> DictConfig:
    ...
    if hasattr(args, "keep_only"):
        keep_only = args.keep_only
    else:
        keep_only = 1
    if hasattr(args, "manual_seed"):
        manual_seed = args.manual_seed
    else:
        manual_seed = None
    if hasattr(args, "num_mc_samples"):
        num_mc_samples = args.num_mc_samples
    else:
        num_mc_samples = 1
    if hasattr(args, "sample_params"):
    ...
    cfg.keep_only = keep_only
    cfg.manual_seed = manual_seed
    cfg.num_mc_samples = num_mc_samples
    cfg.sample_params = sample_params
    cfg.ess = ess
